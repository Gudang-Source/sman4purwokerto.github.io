...
$database="aplikasi/siswa/siswa.php";
switch($_GET['pilih']){
default: ?>
...
<?php 			include "aplikasi/siswa/header.php"; ?>
		...
		<table class="tabel" id="results">
			...
			<tr class="tabel">
				...
				<td class="tabel"><a href="<?php    echo"?t=$token&pilih=edit&id=$s[id_siswa]";?>"><b><?php    echo "$s[nama_siswa]";?></b></a></td>
				...
				<td class="tabel">
					<div class="hapusdata"><a href="<?php    echo "$database?t=$token&pilih=siswa&untukdi=hapus&id=$s[id_siswa]";?>">hapus</a></div>
			...
			<tr class="tabel"><td class="tabel" colspan="8"><b>DATA<?php echo $_SESSION['Bsiswa']; ?> BELUM TERSEDIA</b></td></tr>
			<?php     }
			?>
		</table>
    ...
    //--></script>
		...
		case "tambah":
			include "aplikasi/siswa/siswa_tambah.php";
		break;

		case "status":
			include "aplikasi/siswa/siswa_status.php";
		break;	

		case "pindah":
			include "aplikasi/siswa/siswa_pindah.php";
		break;		
		
		case "edit":
			include "aplikasi/siswa/siswa_edit.php";
		break;
		
		case "jenkel":
			include "aplikasi/siswa/siswa_jenkel.php";
		break;
		
		case "kelas":
			include "aplikasi/siswa/siswa_kelas.php";
		break;
		
		case "pencarian":
			include "aplikasi/siswa/siswa_pencarian.php";
		}
		?>
