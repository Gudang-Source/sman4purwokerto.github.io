...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<div class="judulisikanan">
			...
			<div class="menuhorisontalaktif"><a href="pindah.php?t=<?php echo $token; ?>">Pindah<?php echo $_SESSION['Bsekolah']; ?></a></div>
			<div class="menuhorisontal"><a href="kelas.php?t=<?php echo $token; ?>">Kelas</a></div>
<?php 			
if ($_SESSION['jenjang']>4)
{			
?>
			<div class="menuhorisontal"><a href="jurusan.php?t=<?php echo $token; ?>">Jurusan</a></div>
<?php  } ?>
		...
		<div class="atastabel" style="margin-bottom: 10px;">
			...
			<form method="POST" style="float: left" action="siswa.php?t=<?php echo $token; ?>&pilih=status">
				<select name="kelas" onChange="this.form.submit()">
					...
					echo "<option value='$tk[id_kelas]  AND status_siswa=1'>$tk[nama_kelas]</option>";}
					?>
					<option value='1000000 AND status_siswa=2'>Pengumuman Lulus</option>
			...
			<input type="hidden" name="kelas" value="<?php echo $tkku['id_kelas'];?>">
				...
				<select name="kelas_naik" >
					...
					?>
					<option value='1000000'>Pengumuman Lulus</option>
		...
		<table class="tabel" id="results">
			...
			<tr class="tabel">
				...
				<?php if($s['status_siswa']==0){$pilih="alumni.php?t=$token&pilih=edit&id=$s[id_siswa]";}elseif($s['status_siswa']==1){$pilih="siswa.php?t=$token&pilih=edit&id=$s[id_siswa]";}elseif($s['status_siswa']==2){$pilih="siswa.php?t=$token&pilih=edit_lulus&id=$s[id_siswa]";}elseif($s['status_siswa']==3){$pilih="siswa.php?t=$token&pilih=edit_pindah&id=$s[id_siswa]";} ?>
