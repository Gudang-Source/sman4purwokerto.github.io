...
$database="aplikasi/buku/bukutamu.php";
switch($_GET['pilih']){
default: ?>
<h3>Buku Tamu</h3>
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			<?php    
				$no=1;
				$bukutamu=mysql_query("SELECT * FROM ".$DB_KODE."_buku_tamu ORDER BY id_bukutamu DESC");
    ...
    //--></script>
		...
		case "tambah":
			include "aplikasi/buku/buku_tambah.php";
		break;
		
		case "edit":
			include "aplikasi/buku/buku_edit.php";
		break;
		
		case "pencarian":
			include "aplikasi/buku/buku_pencarian.php";
		break;
		
		case "terima":
			include "aplikasi/buku/buku_terima.php";
		break;
		
		case "tolak":
			include "aplikasi/buku/buku_tolak.php";
		}
		?>
