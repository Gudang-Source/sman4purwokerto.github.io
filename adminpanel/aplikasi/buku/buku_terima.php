...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			<?php    
				$no=1;
				$bukutamu=mysql_query("SELECT * FROM ".$DB_KODE."_buku_tamu WHERE status='1' ORDER BY id_bukutamu DESC");
			...
			<tr class="tabel">
				...
				<td class="tabel">
					<div class="hapusdata"><a href="<?php    echo "$database?t=$token&pilih=terima&untukdi=hapus&id=$b[id_bukutamu]";?>">hapus</a></div>
					<div class="editdata"><a href="<?php    echo "?t=$token&pilih=edit&id=$b[id_bukutamu]";?>">edit</a></div>
					<div class="bataldata"><a href="<?php    echo "$database?t=$token&pilih=terima&untukdi=tolak&id=$b[id_bukutamu]";?>">tolak</a></div>
