...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="isian">
		<form method='POST'<?php     echo "action='$database?t=$token&pilih=bukutamu&untukdi=tambah'";?> name='tambahbuku' id='tambahbuku' >
			
			<tr><td valign="top" class="isiankanan" width="175px">Nama Pengirim</td><td class="isian"><input type="text" name="nama_pengirim" class="maksimal"></td></tr>
			<tr><td valign="top" class="isiankanan" width="175px">Email</td><td class="isian"><input type="text" name="email" class="sedang"></td></tr>
			<tr><td valign="top" class="isiankanan" width="175px">Subjek</td><td class="isian"><input type="text" name="subjek" class="maksimal"></td></tr>
			<tr><td valign="top" class="isiankanan" width="175px">Isi Pesan</td><td class="isian"><textarea name="isi_pesan" style="height: 100px"></textarea></td></tr>
			<tr><td valign="top" class="isiankanan" width="175px">Tanggal Kirim</td><td class="isian"><input type="text" id="tanggal" name="tanggal_kirim" class="pendek"></td></tr>
