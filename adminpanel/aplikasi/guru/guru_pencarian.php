...
<?php 			include "aplikasi/guru/header.php"; ?>
		...
		<table class="tabel" id="results">
			...
			$no=1;
			$guru=mysql_query("SELECT * FROM ".$DB_KODE."_guru_mapel, ".$DB_KODE."_mapel WHERE ".$DB_KODE."_guru_mapel.id_mapel=".$DB_KODE."_mapel.id_mapel AND nama_gurustaff LIKE '%$cari%' AND posisi='guru' ORDER BY id_gurustaff DESC");
			...
			<tr class="tabel">
				...
				<td class="tabel">
					<div class="hapusdata"><a href="<?php    echo "$database?t=$token&pilih=guru&untukdi=hapus&id=$g[id_gurustaff]";?>">hapus</a></div>
