...
<?php 			include "aplikasi/materi/header.php"; ?>
		...
		<table class="tabel" id="results">
			...
			$no=1;
			$materi=mysql_query("SELECT * FROM ".$DB_KODE."_materi, ".$DB_KODE."_mapel WHERE ".$DB_KODE."_materi.id_mapel=".$DB_KODE."_mapel.id_mapel  AND judul_materi LIKE '%$cari%'ORDER BY id_materi DESC");
