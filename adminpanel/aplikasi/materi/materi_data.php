...
<?php 			include "aplikasi/materi/header.php"; ?>
		...
		<table class="tabel" id="results">
			...
			<?php    
			$no=1;
			$materi=mysql_query("SELECT * FROM ".$DB_KODE."_materi, ".$DB_KODE."_mapel WHERE ".$DB_KODE."_materi.id_mapel=".$DB_KODE."_mapel.id_mapel ORDER BY id_materi DESC");
    ...
    //--></script>
		...
		case "tambah":
			include "aplikasi/materi/materi_tambah.php";
		break;
		
		case "tambah2":
			include "aplikasi/materi/materi_tambah2.php";
		break;
		
		case "edit":
			include "aplikasi/materi/materi_edit.php";
		break;
		
		case "pencarian":
			include "aplikasi/materi/materi_pencarian.php";
		break;
		
		case "mapel":
			include "aplikasi/materi/materi_mapel.php";
		}
		?>
