...
<?php 			include "aplikasi/staff/header.php"; ?>
		...
		<table class="tabel" id="results">
			...
			$no=1;
			$staff=mysql_query("SELECT * FROM ".$DB_KODE."_guru_staff, ".$DB_KODE."_jabatan WHERE ".$DB_KODE."_guru_staff.id_jabatan=".$DB_KODE."_jabatan.id_jabatan AND nama_gurustaff LIKE '%$cari%' AND posisi='staff' ORDER BY id_gurustaff DESC");
			...
			<tr class="tabel"><td class="tabel" colspan="8"><b>NAMA PEGAWAI DENGAN KATA KUNCI <u><?php    echo "$cari";?></u> TIDAK DITEMUKAN</b></td></tr>
			<?php     }
			?>
