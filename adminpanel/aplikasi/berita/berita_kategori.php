...
<?php 			include "aplikasi/berita/header.php"; ?>	
		...
		<table class="tabel" id="results">
			...
			$no=1;
			if($_SESSION['leveluser']=='0'){
			$databerita=mysql_query("SELECT * FROM ".$DB_KODE."_berita,".$DB_KODE."_users, ".$DB_KODE."_kategori WHERE ".$DB_KODE."_berita.s_username=".$DB_KODE."_users.s_username AND ".$DB_KODE."_berita.id_kategori=".$DB_KODE."_kategori.id_kategori AND ".$DB_KODE."_berita.id_kategori='$_POST[kategori]' ORDER BY id_berita DESC");
			}
			else {
			$databerita=mysql_query("SELECT * FROM ".$DB_KODE."_berita,".$DB_KODE."_users, ".$DB_KODE."_kategori WHERE ".$DB_KODE."_berita.s_username=".$DB_KODE."_users.s_username AND ".$DB_KODE."_berita.id_kategori=".$DB_KODE."_kategori.id_kategori AND ".$DB_KODE."_berita.id_kategori='$_POST[kategori]' AND ".$DB_KODE."_berita.s_username='$_SESSION[adminsh]' ORDER BY id_berita DESC");
			}
			...
			$nama_kategori=mysql_query("SELECT *FROM ".$DB_KODE."_kategori WHERE id_kategori='$_POST[kategori]'");
