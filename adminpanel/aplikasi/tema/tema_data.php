...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<div class="kotakTemaAktif" style="height:auto">
			<?php    
			...
			if($header['file_header']){
				...
				$image_header='no_header.jpg';
			}
			?>
				<tr><td valign="top" class="isiankanan"colspan="2"> Header<br>
				<img src="<?php    echo"../images/header/$image_header";?>" align="center" width="850px" >
				</td></tr>
				<tr><td valign="top" class="isiankanan">Ganti Gambar Header<br>
					<form method='POST'<?php     echo"action='$database?t=$token&pilih=header&ntm=$aktif[nama_tema]'";?> name='installtema' id='installtema' enctype="multipart/form-data">
					<input type='hidden' name='tema' value="<?php    echo $aktif['nama_tema'];?>">
					<input type="file" name="fupload">
						<input type="submit" class="pencet" value="U P L O A D">
					</form>		</td><td class="isian">
					<form method='POST'<?php     echo"action='$database?t=$token&pilih=hapus&untukdi=hapus'";?> name='installtema' id='installtema' >
					<input type='hidden' name='tema' value="<?php    echo $aktif['nama_tema'];?>">
						<input type="submit" class="pencet" value="H A P U S">
					</form>						
				</td></tr>		
			</table>
		</div>			
		...
		<tr><td class="isian" colspan="2" style="color:#7f7f7f;"><i>
			Tim Support CMS Formulasi menyediakan tema gratis yang bisa didownload di <a href="Http://tema.formulasi.or.id/" target="_blank"><b>Http://tema.formulasi.or.id/</b></a> tema yang dapat anda gunakan untuk website anda, silahkan di kostumisasi jika tema dari kami belum sesuai dengan
...
?>
		...
		case "header":
			include "aplikasi/tema/tema_header.php";
}
		?>
<?php     }?>
