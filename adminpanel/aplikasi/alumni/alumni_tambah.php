...
<?php 			include "aplikasi/alumni/header.php"; ?>
		...
		<table class="isian">
		<form method='POST' <?php     echo "action='$database?t=$token&pilih=alumni&untukdi=tambah'";?>  name='tambahalumni' id='tambahalumni'   enctype="multipart/form-data">
			
			<tr><td valign="top" class="isiankanan" width="175px">Nama Alumni</td><td class="isian"><input type="text" name="nama_alumni" class="maksimal"></td></tr>
			...
			<tr><td valign="top" class="isiankanan" width="175px">Pekerjaan Sekarang</td><td class="isian"><input type="text" name="pekerjaan_sekarang" class="maksimal"></td></tr>
