...
<?php 			include "aplikasi/alumni/header.php"; ?>
		...
		<table class="isian">
		<form method='POST'<?php     echo "action='$database?t=$token&pilih=alumni&untukdi=edit'";?> name='editalumni' id='editalumni'   enctype="multipart/form-data">
		<?php   
$id=ceknomor($_GET['id']);		
		...
		?>
			...
			<tr><td valign="top" class="isiankanan" width="175px">Nama Alumni</td><td class="isian"><input type="text" name="nama_alumni" class="maksimal" value="<?php    echo"$r[nama_siswa]";?>"></td></tr>
			...
			<tr><td valign="top" class="isiankanan" width="175px">Tahun Lulus</td><td class="isian">
			<?php    
				$thn_skrg=date("Y");
				global $ns;
			...
			<tr><td valign="top" class="isiankanan" width="175px">Pekerjaan Sekarang</td><td class="isian"><input type="text" name="pekerjaan_sekarang" class="maksimal"value="<?php    echo"$r[pekerjaan_sekarang]";?>"></td></tr>
