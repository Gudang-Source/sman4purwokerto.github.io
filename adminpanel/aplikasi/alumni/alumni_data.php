...
$database="aplikasi/alumni/alumni.php";
switch($_GET['pilih']){
default: ?>
<h3>Alumni</h3>
...
<?php 			include "aplikasi/alumni/header.php"; ?>
		...
		<table class="tabel" id="results">
			...
			<?php    
			$no=1;
			$alumni=mysql_query("SELECT * FROM ".$DB_KODE."_siswa WHERE status_siswa='0' ORDER BY nama_siswa");
    ...
    //--></script>
		...
		case "tambah":
			include "aplikasi/alumni/alumni_tambah.php";
		break;
		
		case "edit":
			include "aplikasi/alumni/alumni_edit.php";
		break;
		
		case "pencarian":
			include "aplikasi/alumni/alumni_pencarian.php";
		break;
		
		case "jenkel":
			include "aplikasi/alumni/alumni_jenkel.php";
		break;
		
		case "tahun":
			include "aplikasi/alumni/alumni_tahun.php";
		}
		?>
