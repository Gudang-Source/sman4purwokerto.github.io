...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="isian">
		<form method='POST'<?php     echo"action=$database?t=$token&pilih=psb&untukdi=tambah";?> name='tambahpendaftar' id='tambahpendaftar' >
			
			<tr><td valign="top" class="isiankanan" width="175px">Nama Pendaftar</td><td class="isian"><input type="text" name="nama_pendaftar" class="maksimal"></td></tr>
			<tr><td valign="top" class="isiankanan" width="175px">NEM</td><td class="isian"><input type="text" name="nem" class="pendek" style="width:10%"></td></tr>
			<tr><td valign="top" class="isiankanan" width="175px">No. STTB</td><td class="isian"><input type="text" name="no_sttb" class="pendek"></td></tr>
			<tr><td valign="top" class="isiankanan" width="175px">Tanggal STTB</td><td class="isian"><input type="text" id="tanggal1" name="tanggal_sttb" class="pendek"></td></tr>
			<tr><td valign="top" class="isiankanan" width="175px"><?php echo $_SESSION['Bsekolah'];?> Asal</td><td class="isian"><input type="text" name="sekolah_asal" class="pendek"></td></tr>
			<tr><td valign="top" class="isiankanan" width="175px">Jenis Kelamin</td>
			<td class="isian">
					<input type="radio" name="jk" value="L"/>Laki-laki&nbsp;
					<input type="radio" name="jk" value="P"/>Perempuan
			</td></tr>
			<tr><td valign="top" class="isiankanan" width="175px">Tempat, Tanggal Lahir</td><td class="isian"><input type="text" name="tempat_lahir" class="pendek">, <input type="text" id="tanggal" name="tanggal_lahir" class="pendek" style="width:20%"></td></tr>
			<tr><td valign="top" class="isiankanan" width="175px">Tinggi Badan</td><td class="isian"><input type="text" name="tb" class="pendek" style="width:10%">&nbsp;cm</td></tr>
			<tr><td valign="top" class="isiankanan" width="175px">Berat Badan</td><td class="isian"><input type="text" name="bb" class="pendek" style="width:10%">&nbsp;kg</td></tr>
			<tr><td valign="top" class="isiankanan" width="175px">Alamat Pendaftar</td><td class="isian"><textarea name="alamat" style="height: 100px"></textarea></td></tr>
			...
			<tr><td valign="top" class="isiankanan" width="175px">Nama Orang Tua</td><td class="isian"><input type="text" name="nama_ortu" class="maksimal"></td></tr>
			<tr><td valign="top" class="isiankanan" width="175px"><b>Pekerjaan Orang Tua *</b></td><td>
