...
$database="aplikasi/pindah/pindah.php";
switch($_GET['pilih']){
default: ?>
...
<?php 			include "aplikasi/pindah/header.php"; ?>
		...
		<table class="tabel" id="results">
			...
			<?php    
			$no=1;
			$pindah=mysql_query("SELECT * FROM ".$DB_KODE."_siswa WHERE status_siswa='3' ORDER BY nama_siswa");
			...
			<tr class="tabel"><td class="tabel" colspan="9"><b>DATA BELUM TERSEDIA</b></td></tr>
			<?php     }
			?>
    ...
    //--></script>
		...
		case "tambah":
			include "aplikasi/pindah/pindah_tambah.php";
		break;
		
		case "edit":
			include "aplikasi/pindah/pindah_edit.php";
		break;
		
		case "pencarian":
			include "aplikasi/pindah/pindah_pencarian.php";
		break;
		
		case "jenkel":
			include "aplikasi/pindah/pindah_jenkel.php";
		break;
		
		case "tahun":
			include "aplikasi/pindah/pindah_tahun.php";
		}
		?>
