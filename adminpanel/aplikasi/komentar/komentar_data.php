...
$database="aplikasi/komentar/komentar.php";
switch($_GET['pilih']){
default: ?>
<h3>Komentar</h3>
...
<?php 			include "aplikasi/komentar/header.php"; ?>	
		...
		<table class="tabel" id="results">
			...
			$no=1;
			if($_SESSION[leveluser]=='0'){
			$komentar=mysql_query("SELECT * FROM ".$DB_KODE."_komentar, ".$DB_KODE."_berita WHERE ".$DB_KODE."_komentar.id_berita=".$DB_KODE."_berita.id_berita ORDER BY id_komentar DESC");
			}
			else {
			$komentar=mysql_query("SELECT * FROM ".$DB_KODE."_komentar, ".$DB_KODE."_berita WHERE ".$DB_KODE."_komentar.id_berita=".$DB_KODE."_berita.id_berita AND ".$DB_KODE."_berita.s_username='$_SESSION[adminsh]' ORDER BY id_komentar DESC");
			}
...
case "tambah":
include "aplikasi/komentar/komentar_tambah.php";
break;

case "edit":
include "aplikasi/komentar/komentar_edit.php";
break;

case "diterima":
include "aplikasi/komentar/komentar_terima.php";
break;

case "ditolak":
include "aplikasi/komentar/komentar_tolak.php";
break;

case "pencarian":
include "aplikasi/komentar/komentar_pencarian.php";
