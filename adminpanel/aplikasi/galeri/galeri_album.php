...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			<?php    
				$no=1;
				$galeri=mysql_query("SELECT * FROM ".$DB_KODE."_galeri, ".$DB_KODE."_album WHERE ".$DB_KODE."_galeri.id_album=".$DB_KODE."_album.id_album AND ".$DB_KODE."_galeri.id_album='$_POST[album]' ORDER BY id_galeri DESC");
			...
			<?php    
			$nama_album=mysql_query("SELECT * FROM ".$DB_KODE."_album WHERE id_album='$_POST[album]'");
