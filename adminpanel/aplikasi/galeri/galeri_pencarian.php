...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			$cari = htmlentities(htmlspecialchars($cari), ENT_QUOTES);
				$no=1;
				$galeri=mysql_query("SELECT * FROM ".$DB_KODE."_galeri, ".$DB_KODE."_album WHERE ".$DB_KODE."_galeri.id_album=".$DB_KODE."_album.id_album AND nama_galeri LIKE '%$cari%' ORDER BY id_galeri DESC");
