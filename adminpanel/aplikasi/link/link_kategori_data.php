...
?>
		...
		<div class="judulbox">Data Kategori Link</div>
		<table class="tabel" style="width: 95%;">
			...
			<?php    
			$no=1;
			$kategori=mysql_query("SELECT * FROM ".$DB_KODE."_kategori where fungsi='link' ORDER BY id_kategori DESC");
			...
			<tr class="tabel">
				...
				echo "<div class='editdata'><a href='?t=$token&pilih=edit_kategori&id=$kat[id_kategori]'>edit</a></div>";}
				else {
				echo "<div class='hapusdata'><a href='$database?t=$token&pilih=kategori&untukdi=hapus&id=$kat[id_kategori]'>hapus</a></div>
					<div class='editdata'><a href='?t=$token&pilih=edit_kategori&id=$kat[id_kategori]'>edit</a></div>"; }
				?>
				</td>
			</tr>
			<?php    
