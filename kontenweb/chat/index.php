...
include "../../konfigurasi/koneksi.php";
	...
	if (isset($_POST['pesan'])<>'' ){	
		...
		if ($pesan<>'' or $pengirim<>''){	
				mysql_query("INSERT INTO ".$DB_KODE."_chat (pesan, pengirim)VALUES('$pesan', '$pengirim')");
		}				
	}
...
#pesan{
	...
	border-left: 4px solid #3366FF;
	width: 320px;
	margin-top: 5px; padding-top: 5px; padding-bottom: 5px; padding-left: 5px; width: 415px;
}
#texta{
	border: 1px solid #3366FF;
	border-left: 4px solid #3366FF;
...
$result = mysql_query("SELECT * FROM ".$DB_KODE."_chat where id_pbm='' ORDER BY id DESC");
