...
$dir= "../file/pengayaan/";
mysql_query("UPDATE ".$DB_KODE."_pengayaan SET download=download+1 WHERE id_pengayaan='$id'");
$file=mysql_query("SELECT * FROM ".$DB_KODE."_pengayaan WHERE id_pengayaan='$id'");
$r=mysql_fetch_array($file);
$filename=$r[file_pengayaan];
