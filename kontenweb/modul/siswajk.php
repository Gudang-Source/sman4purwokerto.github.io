...
$title='Profil '.$_SESSION['Bsiswa'].' Gender';
...
$siswa=mysql_query("SELECT * FROM ".$DB_KODE."_siswa, ".$DB_KODE."_kelas WHERE ".$DB_KODE."_siswa.id_kelas=".$DB_KODE."_kelas.id_kelas  AND status_siswa='1' AND jenkel='$jksiswa' ORDER BY nama_siswa ASC");
...
<tr class="garis"><td class="garis" colspan="4">Data <?php echo $_SESSION['Bsiswa']; ?> <?php    
if(isset($_POST['jk'])=='L'){ echo "Laki-laki"; }
else { echo "Perempuan"; }
