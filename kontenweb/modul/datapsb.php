...
$title='Pengumuman Pendaftaran '.$_SESSION['Bsiswa'].' Baru';
...
<table class="garis" id="results">
	<tr>
		<th class="garis" width="35px">No</th><th class="garis">Nama Pendaftar</th><th class="garis">NEM</th><th class="garis"><?php echo $_SESSION['Bsekolah'];?> Asal</th><th class="garis">Status</th>
	</tr>
	<?php    
	$no=1;
