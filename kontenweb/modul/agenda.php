...
echo "<br><hr>";
		if ($halaman > 1){
		$prev=$halaman-1;
		echo 	"	<div class='hal' style='float: left'><a href='halaman-$prev-agenda.html' title='Halaman Sebelumnya'>&laquo; Sebelumnya</a></div>";
		}
		if ($halaman < $jmlhal) {
		$next=$halaman+1;
		echo "	<div class='hal' style='float: right'><a href='halaman-$next-agenda.html' title='halaman Berikutnya'>Berikutnya &raquo;</a></div>"; }
