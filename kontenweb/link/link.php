...
<?php    
$no=1;
$link=mysql_query("SELECT * FROM ".$DB_KODE."_sidebar, ".$DB_KODE."_kategori  WHERE ".$DB_KODE."_sidebar.kategori=".$DB_KODE."_kategori.id_kategori  AND ".$DB_KODE."_sidebar.jenis='link' AND ".$DB_KODE."_sidebar.status='1' ORDER BY ".$DB_KODE."_sidebar.kategori ASC");
$hitunglink=mysql_num_rows($link);
