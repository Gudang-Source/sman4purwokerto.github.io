...
<?php
if (isset($_POST['cari'])){
$carix = trim($_POST['cari']);
$carix = htmlentities(htmlspecialchars($carix), ENT_QUOTES);
$cari="AND (nama LIKE '%$carix%' or isi1 LIKE '%$carix%' or isi2 LIKE '%$carix%') ";
}else{$cari="";}
?>
<div id="konten">
<div id="lebar">
...
$no=1;
$link=mysql_query("SELECT * FROM ".$DB_KODE."_sidebar, ".$DB_KODE."_kategori  WHERE ".$DB_KODE."_sidebar.kategori=".$DB_KODE."_kategori.id_kategori  AND ".$DB_KODE."_sidebar.jenis='link' AND ".$DB_KODE."_sidebar.status='1'  $cari ORDER BY ".$DB_KODE."_sidebar.kategori ASC");
$hitunglink=mysql_num_rows($link);
...
<tr class="garis"><td colspan="4"><b>Data link Tidak ditemukan</b></td></tr>
<?php     } ?>
</table>
