...
$dir= "../file/tugas/";
mysql_query("UPDATE ".$DB_KODE."_tugas SET download=download+1 WHERE id_tugas='$id'");
$file=mysql_query("SELECT * FROM ".$DB_KODE."_tugas WHERE id_tugas='$id'");
$r=mysql_fetch_array($file);
$filename=$r[file_tugas];
