...
$dir= "../file/media/";
mysql_query("UPDATE ".$DB_KODE."_media SET download=download+1 WHERE id_media='$id'");
$file=mysql_query("SELECT * FROM ".$DB_KODE."_media WHERE id_media='$id'");
$r=mysql_fetch_array($file);
$filename=$r[file_media];
